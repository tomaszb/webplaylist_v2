...
(function() {
  this.notice = function(element, color) {
    element.animate({
...
(function() {
  ...
  window.onPlayerStateChange = function(event) {
    ...
    if (event.data === YT.PlayerState.ENDED) {
      ...
      return $(".song-" + (window.index_song + 1)).addClass('selected_song');
    }
  };

  window.stopVideo = function() {
    return window.player.stopVideo();
  };

  $(function() {
    $('.song_part').click(function() {
      console.log("song click");
      window.all_songs = $(this).data('songs');
      window.index_song = $(this).data('index');
      window.player.loadVideoById(window.all_songs[window.index_song].youtubeid);
      $('.selected_song').removeClass('selected_song');
      return $(this).addClass('selected_song');
    });
    return $('.playlist_part').click(function() {
      console.log("gothere");
      window.index_playlist = $(this).data('index');
      $('.pl_selected').removeClass("pl_selected");
      return $(this).find('li').addClass('pl_selected');
    });
  });
